...
<template>
  <section class="controls">
    ...
    <details>
      ...
      <ul>
        <li>元アイコンおよび本サービスに関する著作権その他の権利は、制作者に帰属します。</li>
        <li>利用者は、本サービス上で生成した画像を、個人の非営利目的に限り使用できます。</li>
        <li>
          商用利用（広告収入のある利用、宣伝・販売促進、商品化、企業アカウントでの利用等）は禁止します。
        </li>
        <li>
          ikura-hamu
          本人が作成・公認したものであると誤認させる利用、なりすまし目的の利用は禁止します。
        </li>
        <li>
          法令違反、公序良俗に反する利用、誹謗中傷、差別的表現、第三者の権利侵害にあたる利用は禁止します。
        </li>
        <li>
          運営者は、上記に反すると判断した場合、画像の削除、公開停止、利用制限その他必要な措置を行うことがあります。
        </li>
        <li>規約は予告なく変更されることがあります。</li>
      </ul>
    </details>
